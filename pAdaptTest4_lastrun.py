...
expName = 'pAdaptTest4'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\p-adapt-test4\\pAdaptTest4_lastrun.py',
...
for thisTrials2 in trials2:
    ...
    targetangle = targetAngles1[trials2.thisN]
    targetangle_rad = pi*(targetangle/180)
    targetPos = (cos(targetangle_rad)*0.4, sin(targetangle_rad)*0.4)
...
for thisTrials3 in trials3:
    ...
    while continueRoutine:
        ...
        if trial3Cursor.status == STARTED:  # only update if drawing
            trial3Cursor.setPos(((trial3Mouse.getPos()[0]*cos(r))-(trial3Mouse.getPos()[1]*sin(r)), (trial3Mouse.getPos()[0]*sin(r))+(trial3Mouse.getPos()[1]*cos(r))), log=False)
...
for thisTrials4 in trials4:
    ...
    _trial4Skip_allKeys = []
    # keep track of which components have finished
    trial4Components = [trial4Mouse, trial4Target, trial4Home, trial4Cursor, trial4Num, trial4Skip]
